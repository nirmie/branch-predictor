// Tuned TAGE branch predictor.
//
// Self-contained copy of the reference TAGE with template defaults fixed to
// hyperparameters selected by genetic-algorithm design-space exploration on
// gcc_test_trace.gz (CBP-NG, 1M warmup / 40M measure):
//
...
//
// Compile with:
//   ./compile cbp -DPREDICTOR="tage_tuned<>"
...
template<u64 LOGLB=6, u64 NUMG=7, u64 LOGG=11, u64 LOGB=11, u64 TAGW=12, u64 GHIST=100, u64 LOGP1=13, u64 GHIST1=10>
struct tage_tuned : predictor {
